...
Agora, partindo pro recado, eu acabei fazendo o programa "do zero" em apenas um e não apenas editando getline e read-events.
Tudo bem ter feito isso? Claro que reutilizei coisas q foram feitas, como o filtro e estrutura da saída final.
(fiz diversos testes e me diverti bastante, além de ter batido cabeça haha)

Enfim, pelo que eu havia entendido, era so n deixar a entrada padrão stdio, e sim, colocar para ser aberto 
pelo fopen, era essa a ideia, certo?. Na hora de fzr o programa optei fzr tudo junto, sem ser apenas 
modificações do getline e read-events na entrada. Achei assim mais prático e interessante.
Colocando um loop pra ler as linhas enquanto aplica o filtro e a estrutua que foi mostrada me pareceu uma ideia boa. 
...
Eu sei q n era p fzr um programa exatamente assim, mas acaba fznd a msm coisa no final e fica mais prático.
Espero que eu tenha entregue o que foi pedido, haha. Já que eu vou estar entregando apenas este e não dois arquivos.
Tudo bem?
Abração!! -e desculpe o atraso dnv-*/
